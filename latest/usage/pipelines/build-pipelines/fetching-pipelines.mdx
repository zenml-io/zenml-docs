...
Check out the [ZenML Client Documentation](/latestsdk/python-client) for more information on the `Client` class and its purpose.
...
<Info>
    Alternatively, you can also use the `pipeline_model.get_runs()` method which allows you to specify detailed parameters for filtering or pagination. See the [ZenML SDK Docs](/latestsdk/python-client#list-of-resources) for more information.
</Info>
