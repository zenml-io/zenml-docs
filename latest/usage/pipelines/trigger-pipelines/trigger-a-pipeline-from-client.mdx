...
<CardGroup>
 <Card title="Run Pipeline from Another" icon="diagram-project" href="/latest/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-another" horizontal/> <Card title="Run Pipeline from REST API" icon="code" href="/latest/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-rest-api" horizontal/></CardGroup>
