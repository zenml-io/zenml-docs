...
For complete details, refer to the [containerization page](latest/usage/project-setup/customize-docker-builds). Here's an example using a CUDA-enabled PyTorch image:
