...
1. Using a [Service Connector](latest/usage/resource-data-management/auth-management/service-connectors-guide) to connect to the remote cluster (recommended for cloud-managed clusters). No local `kubectl` context needed.
...
For more advanced options and details, refer to the [full Kubeflow Orchestrator documentation](latest/stack-components/orchestrators/kubeflow).
