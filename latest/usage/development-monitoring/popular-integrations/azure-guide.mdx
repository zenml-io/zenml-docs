...
Once you have created the service principal and the client secret, you can go ahead and create [a ZenML Azure Service Connector](latest/usage/resource-data-management/auth-management/azure-service-connector).
...
For more information regarding Azure Blob Storage artifact stores, feel free to [check the docs](latest/stack-components/artifact-stores/azure).
...
For more information regarding AzureML orchestrator, feel free to [check the docs](latest/stack-components/orchestrators/azureml).
...
For more information regarding Azure container registries, feel free to [check the docs](latest/stack-components/container-registries/azure).
