...
<Info>
Instead of hardcoding an experiment tracker name, you can also use the [Client](/latestsdk/python-client) to dynamically use the experiment tracker of your active stack:
