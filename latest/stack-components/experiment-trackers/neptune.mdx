...
You should consider one of the other [Experiment Tracker flavors](latest/stack-components/experiment-trackers#experiment-tracker-flavors) if you have never worked with neptune.ai before and would rather use another experiment tracking tool that you are more familiar with.
...
This method requires you to [configure a ZenML secret](latest/usage/project-setup/use-secrets/interact-with-secrets) to store the Neptune tracking service credentials securely.
