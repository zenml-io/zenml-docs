...
* [generating synthetic data with distilabel](latest/user-guide/guides/llmops-guide/finetuning-embeddings/synthetic-data-generation)
* [finetuning embeddings with Sentence Transformers](latest/user-guide/guides/llmops-guide/finetuning-embeddings/finetuning-embeddings-with-sentence-transformers)
* [evaluating finetuned embeddings and using ZenML's model control plane to get a systematic overview](latest/user-guide/guides/llmops-guide/finetuning-embeddings/evaluating-finetuned-embeddings)
