...
subtitle: >-
  Sometimes you may need to authenticate to a ZenML server from a
  non-interactive environment where the web login is not possible, like a CI/CD
  workload or a serverless function.
slug: >-
  usage/resource-data-management/connecting-to-zenml/connect-with-a-service-account
---
