...
slug: usage/resource-data-management/auth-management/aws-service-connector
---
...
The [S3 Artifact Store Stack Component](../../../stack-components/artifact-stores/s3.mdx) can be connected to a remote AWS S3 bucket through an AWS Service Connector.
...
* a [Kubernetes Orchestrator](../../../stack-components/orchestrators/kubernetes.mdx) connected to an EKS Kubernetes cluster
* an [S3 Artifact Store](../../../stack-components/artifact-stores/s3.mdx) connected to an S3 bucket
* an [ECR Container Registry](../../../stack-components/container-registries/aws.mdx) stack component connected to an ECR container registry
