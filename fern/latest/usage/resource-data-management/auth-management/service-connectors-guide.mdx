...
subtitle: >-
  ...
  external resources.
slug: usage/resource-data-management/auth-management/service-connectors-guide
---
...
Service Connector Types like the [Kubernetes Service Connector](kubernetes-service-connector.mdx) and [Docker Service Connector](docker-service-connector.mdx) can only handle one resource at a time: a Kubernetes cluster and a Docker container registry respectively. These basic Service Connector Types are the easiest to instantiate and manage, as each Service Connector instance is tied exactly to one resource (i.e. they are _single-instance_ connectors).
...
* [the AWS Service Connector end-to-end examples](aws-service-connector.mdx)
* [the GCP Service Connector end-to-end examples](gcp-service-connector.mdx)
* [the Azure Service Connector end-to-end examples](azure-service-connector.mdx)
