...
subtitle: >-
  ...
  data into your steps.
slug: >-
  usage/resource-data-management/handle-data-artifacts/load-artifacts-into-memory
---
...
<Note>
We recommend using models to group and access artifacts across pipelines. Find out how to load an artifact from a ZenML Model [here](../../development-monitoring/use-the-model-control-plane/load-artifacts-from-model.mdx).
</Note>
