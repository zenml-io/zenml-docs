...
title: Overview
subtitle: >-
  A ZenML Model is a concept that more broadly encapsulates your ML products
  business logic.
slug: >-
  usage/development-monitoring/use-the-model-control-plane/use-the-model-control-plane
---
...
To see an end-to-end example, please refer to the [starter guide](../../../user-guide/guides/starter-guide/track-ml-models.mdx).
