...
subtitle: >-
  If you want to run just a single step remotely from a notebook, you can simply
  call the step as you would with a normal Python function.
slug: >-
  usage/development-monitoring/run-remote-steps-and-pipelines-from-notebooks/run-a-single-step-from-a-notebook
---
...
<Info>
    When defining a step that should be run remotely in a notebook, make sure you're aware of all the [limitations](limitations-of-defining-steps-in-notebook-cells.mdx) that apply.
</Info>
