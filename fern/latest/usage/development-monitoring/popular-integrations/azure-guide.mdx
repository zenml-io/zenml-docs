---
title: Run on Azure
subtitle: A simple guide to create an Azure stack to run your ZenML pipelines
slug: usage/development-monitoring/popular-integrations/azure-guide
---
...
* ZenML [installed](../../../getting-started/installation.mdx).
...
<img src="../../../_assets/how-to/stack-71.png"/>
</Frame>

<Frame caption="Azure App Registrations">
<img src="../../../_assets/how-to/stack-72.png"/>
</Frame>
...
<Frame caption="Azure App Registrations">
<img src="../../../_assets/how-to/stack-73.png"/>
</Frame>

## 2. Create a service connector

Once you have created the service principal and the client secret, you can go ahead and create [a ZenML Azure Service Connector](../../resource-data-management/auth-management/azure-service-connector.mdx).
...
<img src="../../../_assets/how-to/stack-74.png"/>
</Frame>
...
<img src="../../../_assets/how-to/stack-75.png"/>
</Frame>
...
<img src="../../../_assets/how-to/stack-76.png"/>
</Frame>
...
<img src="../../../_assets/how-to/stack-77.png"/>
</Frame>
...
For more information regarding Azure Blob Storage artifact stores, feel free to [check the docs](../../../stack-components/artifact-stores/azure.mdx).
...
For more information regarding AzureML orchestrator, feel free to [check the docs](../../../stack-components/orchestrators/azureml.mdx).
...
For more information regarding Azure container registries, feel free to [check the docs](../../../stack-components/container-registries/azure.mdx).
...
* Explore ZenML's [integrations](../../../stack-components/component-guide.mdx) with other popular tools and frameworks in the machine learning ecosystem.
