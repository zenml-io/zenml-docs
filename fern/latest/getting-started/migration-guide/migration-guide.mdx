---
title: Overview
subtitle: How to migrate your ZenML code to the newest version.
slug: getting-started/migration-guide/migration-guide
---
...
* [Migration guide 0.13.2 to 0.20.0](migration-zero-twenty.mdx)
* [Migration guide 0.23.0 to 0.30.0](migration-zero-thirty.mdx)
* [Migration guide 0.39.1 to 0.41.0](migration-zero-forty.mdx)
