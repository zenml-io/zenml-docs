...
subtitle: >-
  How to migrate your ZenML pipelines and steps from version up to and including
  0.39.1 to 0.41.0.
slug: getting-started/migration-guide/migration-zero-forty
---
...
Check out [this page](../../usage/pipelines/build-pipelines/use-pipeline-step-parameters.mdx) for more information on how to parameterize your steps.
...
Check out [this page](../../usage/pipelines/build-pipelines/schedule-a-pipeline.mdx) for more information on how to schedule your pipelines.
...
Check out [this page](../../usage/resource-data-management/track-metrics-metadata/fetch-metadata-within-steps.mdx) for more information on how to programmatically fetch information about previous pipeline runs.
...
Check out [this page](../../usage/pipelines/build-pipelines/control-execution-order-of-steps.mdx) for more information on how to control the step execution order.
...
Check out [this page](../../usage/pipelines/build-pipelines/step-output-typing-and-annotation.mdx) for more information on how to annotate your step outputs.
...
Check out [this page](../../usage/resource-data-management/track-metrics-metadata/fetch-metadata-within-steps.mdx) for more information on how to fetch run information inside your steps using `get_step_context()`.
