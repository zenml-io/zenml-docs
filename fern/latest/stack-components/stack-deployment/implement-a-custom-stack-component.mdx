...
subtitle: How to write a custom stack component flavor
slug: stack-components/stack-deployment/implement-a-custom-stack-component
---
...
<Info>
    If you would like to automatically track some metadata about your custom stack component with each pipeline run, you can do so by defining some additional methods in your stack component implementation class as shown in the [Tracking Custom Stack Component Metadata](../../usage/resource-data-management/track-metrics-metadata/fetch-metadata-within-steps.mdx) section.
</Info>
...
You can read more about the differences [here](../../usage/project-setup/use-configuration-files/runtime-configuration.mdx).
...
<Info>
    You can pass sensitive configuration values as [secrets](../../usage/project-setup/use-secrets/interact-with-secrets.mdx) by defining them as type `SecretField` in the configuration class.
</Info>
...
| ------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Orchestrator](../orchestrators/custom.mdx)              | Orchestrating the runs of your pipeline                           |
| [Artifact Store](../artifact-stores/custom.mdx)          | Storage for the artifacts created by your pipelines               |
| [Container Registry](../container-registries/custom.mdx) | Store for your containers                                         |
| [Step Operator](../step-operators/custom.mdx)            | Execution of individual steps in specialized runtime environments |
| [Model Deployer](../model-deployers/custom.mdx)          | Services/platforms responsible for online model serving           |
| [Feature Store](../feature-stores/custom.mdx)            | Management of your data/features                                  |
| [Experiment Tracker](../experiment-trackers/custom.mdx)  | Tracking your ML experiments                                      |
| [Alerter](../alerters/custom.mdx)                        | Sending alerts through specified channels                         |
| [Annotator](../annotators/custom.mdx)                    | Annotating and labeling data                                      |
| [Data Validator](../data-validators/custom.mdx)          | Validating and monitoring your data                               |
