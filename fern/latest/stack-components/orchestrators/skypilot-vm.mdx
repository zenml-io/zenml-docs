...
subtitle: Orchestrating your pipelines to run on VMs using SkyPilot.
slug: stack-components/orchestrators/skypilot-vm
---
...
* you're not willing to maintain Kubernetes-based solutions or pay for managed solutions like [Sagemaker](sagemaker.mdx).
...
<Note>
    The SkyPilot VM Orchestrator does not currently support the ability to [schedule pipelines runs](../../usage/pipelines/build-pipelines/schedule-a-pipeline.mdx)
</Note>
...
* A [service connector](../../usage/resource-data-management/auth-management/service-connectors-guide.mdx) configured to authenticate with your cloud provider of choice.
...
To provision VMs on AWS, your VM Orchestrator stack component needs to be configured to authenticate with [AWS Service Connector](../../usage/resource-data-management/auth-management/aws-service-connector.mdx). To configure the AWS Service Connector, you need to register a new service connector configured with AWS credentials that have at least the minimum permissions required by SkyPilot as documented [here](https://skypilot.readthedocs.io/en/latest/cloud-setup/cloud-permissions/aws.html).
...
To provision VMs on GCP, your VM Orchestrator stack component needs to be configured to authenticate with [GCP Service Connector](../../usage/resource-data-management/auth-management/gcp-service-connector.mdx)
...
To provision VMs on Azure, your VM Orchestrator stack component needs to be configured to authenticate with [Azure Service Connector](../../usage/resource-data-management/auth-management/azure-service-connector.mdx)
