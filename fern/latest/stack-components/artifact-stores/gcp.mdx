...
subtitle: Storing artifacts using GCP Cloud Storage.
slug: stack-components/artifact-stores/gcp
---
...
To enable these use cases, it is recommended to use [a GCP Service Connector](../../usage/resource-data-management/auth-management/gcp-service-connector.mdx) to link your GCS Artifact Store to the remote GCS bucket.
</Note>
</Tab>
...
When you register the GCS Artifact Store, you can [generate a GCP Service Account Key](https://cloud.google.com/docs/authentication/application-default-credentials#attached-sa), store it in a [ZenML Secret](../../usage/project-setup/use-secrets/secret-management.mdx) and then reference it in the Artifact Store configuration.
