---
title: Seldon
subtitle: Deploying models to Kubernetes with Seldon Core.
slug: stack-components/model-deployers/seldon
---
...
If you are looking for a more easy way to deploy your models locally, you can use the [MLflow Model Deployer](mlflow.mdx) flavor.
...
* [the AWS Service Connector](../../usage/resource-data-management/auth-management/aws-service-connector.mdx), if you are using an AWS EKS cluster.
* [the GCP Service Connector](../../usage/resource-data-management/auth-management/gcp-service-connector.mdx), if you are using a GKE cluster.
* [the Azure Service Connector](../../usage/resource-data-management/auth-management/azure-service-connector.mdx), if you are using an AKS cluster.
* [the generic Kubernetes Service Connector](../../usage/resource-data-management/auth-management/kubernetes-service-connector.mdx) for any other Kubernetes cluster.
...
|   |   |
|---|---|
|<Frame caption="AWS Service Connector Type"><img src="../../_assets/stack-components/stack-components-29.png"/></Frame> | <Frame caption="AWS EKS Service Connector Configuration"> <img src="../../_assets/stack-components/stack-components-30.png"/></Frame>|
...
<Frame caption="Seldon Core Model Deployer Configuration">
  <img src="../../_assets/stack-components/stack-components-31.png"/>
</Frame>
