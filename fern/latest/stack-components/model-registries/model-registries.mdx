---
title: Overview
subtitle: Tracking and managing ML models.
slug: stack-components/model-registries/model-registries
---
...
">
  <img src="../../_assets/stack-components/stack-components-38.png"/>
</Frame>
...
| ------------------------------------------------------------------ | -------- | ----------- | ------------------------------------------ |
| [MLflow](mlflow.mdx)                | mlflow   | mlflow      | Add MLflow as Model Registry to your stack |
