---
title: Kubernetes
subtitle: Executing individual steps in Kubernetes Pods.
slug: stack-components/step-operators/kubernetes
---
...
<Info>
    It is recommended that you set up [a Service Connector](../../usage/resource-data-management/auth-management/service-connectors-guide.mdx) and use it to connect the Kubernetes step operator to the Kubernetes cluster, especially if you are using a Kubernetes cluster managed by a cloud provider like AWS, GCP or Azure.
</Info>

We can then register the step operator and use it in our stacks. This can be done in two ways:

1. Using a Service Connector configured to access the remote Kubernetes cluster. Depending on your cloud provider, this should be either an [AWS](../../usage/resource-data-management/auth-management/aws-service-connector.mdx), [Azure](../../usage/resource-data-management/auth-management/azure-service-connector.mdx) or [GCP](../../usage/resource-data-management/auth-management/gcp-service-connector.mdx) service connector. If you're using a Kubernetes cluster that is not provided by any of these, you can use the generic [Kubernetes](../../usage/resource-data-management/auth-management/kubernetes-service-connector.mdx) service connector. You can then [connect the stack component to the Service Connector](/usage/resource-data-management/auth-management/service-connectors-guide#connect-stack-components-to-resources):
