...
subtitle: Evaluate the generation component of your RAG pipeline.
slug: user-guide/guides/llmops-guide/evaluation/generation
---
...
As with the [retrieval evaluation](retrieval.mdx), we can start with a simple approach and then move on to more sophisticated methods.
