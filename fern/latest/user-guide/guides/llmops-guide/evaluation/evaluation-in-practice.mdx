...
subtitle: Learn how to evaluate the performance of your RAG system in practice.
slug: user-guide/guides/llmops-guide/evaluation/evaluation-in-practice
---
...
There's more we could improve our evaluation system, but for now we can continue onwards to [adding a reranker](../reranking.mdx) to improve our retrieval. This will allow us to improve the performance of our retrieval system without needing to retrain the embeddings. We'll cover this in the next section.
