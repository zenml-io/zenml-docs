...
subtitle: Understand how to ingest and preprocess data for RAG pipelines with ZenML.
slug: user-guide/guides/llmops-guide/rag-with-zenml/data-ingestion
---
...
<Frame>
  <img src="../../../../_assets/user-guide/data-int.png"/>
</Frame>
