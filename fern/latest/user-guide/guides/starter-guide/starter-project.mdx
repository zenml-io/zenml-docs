...
subtitle: Put your new knowledge into action with a simple starter project
slug: user-guide/guides/starter-guide/starter-project
---


By now, you have understood some of the basic pillars of a MLOps system:

* [Pipelines and steps](create-an-ml-pipeline.mdx)
* [Artifacts](manage-artifacts.mdx)
* [Models](track-ml-models.mdx)
...
This marks the end of the first chapter of your MLOps journey with ZenML. Make sure you do your own experimentation with ZenML to master the basics. When ready, move on to the [production guide](../production-guide.mdx), which is the next part of the series.
