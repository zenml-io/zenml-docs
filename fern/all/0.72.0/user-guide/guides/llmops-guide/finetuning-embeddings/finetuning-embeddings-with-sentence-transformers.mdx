...
subtitle: Finetune embeddings with Sentence Transformers.
slug: >-
...
<Frame caption="Synthetic data generated with distilabel for embeddings finetuning">
  <img src="../../../../_assets/user-guide/sy-3.png"/>
</Frame>

Our pipeline for finetuning the embeddings is relatively simple. We'll do the following:

* load our data either from Hugging Face or [from Argilla via the ZenML annotation integration](../../../../stack-components/annotators/argilla.mdx)
...
<Frame caption="Embeddings finetuning pipeline with Sentence Transformers and ZenML">
  <img src="../../../../_assets/user-guide/sy-4.png"/>
</Frame>
...
This assumes that you've set up an Argilla annotator in your stack. The code checks for the annotator and downloads the data that was annotated in Argilla. Please see our [guide to using the Argilla integration with ZenML](../../../../stack-components/annotators/argilla.mdx) for more details.
