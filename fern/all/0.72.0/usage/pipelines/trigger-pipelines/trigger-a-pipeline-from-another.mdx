...
subtitle: Trigger a pipeline from another pipeline.
slug: usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-another
---
...
Read more about Unmaterialized Artifacts [here](../../resource-data-management/handle-data-artifacts/unmaterialized-artifacts.mdx).
