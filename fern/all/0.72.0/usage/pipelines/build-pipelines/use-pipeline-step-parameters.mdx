...
slug: usage/pipelines/build-pipelines/use-pipeline-step-parameters
---
...
<CardGroup cols={2}>
<Card title="Use configuration files to set parameters" icon="gear" href="use-pipeline-step-parameters.mdx" horizontal />
<Card title="How caching works and how to control it" icon="database" href="control-caching-behavior.mdx" horizontal /> </CardGroup>
