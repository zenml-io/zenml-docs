...
subtitle: While reusing Docker builds is useful, it can be limited.
slug: >-
  usage/project-setup/customize-docker-builds/use-code-repositories-to-speed-up-docker-build-times
---
...
* First, the [source root](which-files-are-built-into-the-image.mdx) is computed
...
* If you want to disable or enforce the downloading of files, check out [this docs page](docker-settings-on-a-pipeline.mdx) for the available options.
