...
subtitle: How to set the logging verbosity in ZenML.
slug: usage/development-monitoring/control-logging/set-logging-verbosity
---
...
If you wish to control for [remote pipeline runs](../../../user-guide/guides/production-guide/cloud-orchestration.mdx), you can set the `ZENML_LOGGING_VERBOSITY` environment variable in your pipeline runs environment as follows:
