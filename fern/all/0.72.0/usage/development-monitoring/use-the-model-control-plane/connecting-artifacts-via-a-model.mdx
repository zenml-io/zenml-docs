...
subtitle: Structuring an MLOps project
slug: >-
  usage/development-monitoring/use-the-model-control-plane/connecting-artifacts-via-a-model
---


Now that we've learned about managing [artifacts](../../../user-guide/guides/starter-guide/manage-artifacts.mdx) and [models](../../../user-guide/guides/starter-guide/track-ml-models.mdx), we can shift our attention again to the thing that brings them together: [Pipelines](../../../user-guide/guides/starter-guide/create-an-ml-pipeline.mdx). This trifecta together will then inform how we structure our project.

<Info>
    In order to see the recommended repository structure of a ZenML MLOps project, read the [best practices](../../project-setup/setting-up-a-project-repository/best-practices.mdx) section.
</Info>
...
">
  <img src="../../../_assets/how-to/stack-66.png"/>
</Frame>
...
<Frame caption="A simple artifact exchange between pipelines through the Model Control Plane.">
  <img src="../../../_assets/how-to/stack-67.png"/>
</Frame>
