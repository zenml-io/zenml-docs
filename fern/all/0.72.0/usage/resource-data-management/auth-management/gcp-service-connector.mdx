...
slug: usage/resource-data-management/auth-management/gcp-service-connector
---
...
This generic GCP resource type is meant to be used with Stack Components that are not represented by one of the other, more specific resource types like GCS buckets, Kubernetes clusters, or Docker registries. For example, it can be used with [the Google Cloud Image Builder](../../../stack-components/image-builders/gcp.mdx) stack component, or [the Vertex AI Orchestrator](../../../stack-components/orchestrators/vertex.mdx) and [Step Operator](../../../stack-components/step-operators/vertex.mdx). It should be accompanied by a matching set of GCP permissions that allow access to the set of remote resources required by the client and Stack Component (see the documentation of each Stack Component for more details).
...
The[ GCS Artifact Store Stack Component](../../../stack-components/artifact-stores/gcp.mdx) can be connected to a remote GCS bucket through a GCP Service Connector.

The [Google Cloud Image Builder Stack Component](../../../stack-components/image-builders/gcp.mdx), [VertexAI Orchestrator](../../../stack-components/orchestrators/vertex.mdx), and [VertexAI Step Operator](../../../stack-components/step-operators/vertex.mdx) can be connected and use the resources of a target GCP project through a GCP Service Connector.
...
* a [Kubernetes Orchestrator](../../../stack-components/orchestrators/kubernetes.mdx) connected to a GKE Kubernetes cluster
* a [GCS Artifact Store](../../../stack-components/artifact-stores/gcp.mdx) connected to a GCS bucket
* a [GCP Container Registry](../../../stack-components/container-registries/gcp.mdx) connected to a Docker Google Artifact Registry
* a local [Image Builder](../../../stack-components/image-builders/local.mdx)
...
* a [VertexAI Orchestrator](../../../stack-components/orchestrators/vertex.mdx) connected to the GCP project
* a [GCS Artifact Store](../../../stack-components/artifact-stores/gcp.mdx) connected to a GCS bucket
* a [GCP Container Registry](../../../stack-components/container-registries/gcp.mdx) connected to a GCR container registry
* a [Google Cloud Image Builder](../../../stack-components/image-builders/gcp.mdx) connected to the GCP project
