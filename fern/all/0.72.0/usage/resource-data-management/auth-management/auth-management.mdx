...
slug: usage/resource-data-management/auth-management/auth-management
---
...
<Frame caption="Authentication without Service Connectors">
  <img src="../../../_assets/how-to/stack-78.png"/>
</Frame>
...
The range of features covered by Service Connectors is extensive and going through the entire [Service Connector Guide](service-connectors-guide.mdx) can be overwhelming. If all you want is to get a quick overview of how Service Connectors work and what they can do for you, this section is for you.

This is a representative example of how you would use a Service Connector to connect ZenML to a cloud service. This example uses [the AWS Service Connector](aws-service-connector.mdx) to connect ZenML to an AWS S3 bucket and then link [an S3 Artifact Store Stack Component](../../../stack-components/artifact-stores/s3.mdx) to it.
...
```
2. [a ZenML secret](../../project-setup/use-secrets/secret-management.mdx) can hold the AWS credentials and then be referenced in the S3 Artifact Store configuration attributes:
...
<Frame caption="Authentication without Service Connectors">
  <img src="../../../_assets/how-to/stack-79.png"/>
</Frame>
...
<Frame caption="Authentication with Service Connectors">
  <img src="../../../_assets/how-to/stack-80.png"/>
</Frame>
...
<Frame >
  <img src="../../../_assets/how-to/stack-81.png"/>
</Frame>
...
The AWS Service Connector discovered and lifted the AWS Secret Key that was configured on the local machine and securely stored it in the [Secrets Store](../../project-setup/use-secrets/secret-management.mdx).
