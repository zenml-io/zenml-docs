...
subtitle: >-
  ...
  registries.
slug: usage/resource-data-management/auth-management/azure-service-connector
---
...
The [Azure Artifact Store Stack Component](../../../stack-components/artifact-stores/azure.mdx) can be connected to a remote Azure blob storage container through an Azure Service Connector.
...
* a [Kubernetes Orchestrator](../../../stack-components/orchestrators/kubernetes.mdx) connected to an AKS Kubernetes cluster
* a [Azure Blob Storage Artifact Store](../../../stack-components/artifact-stores/azure.mdx) connected to an Azure blob storage container
* an [Azure Container Registry](../../../stack-components/container-registries/azure.mdx) connected to an ACR container registry
