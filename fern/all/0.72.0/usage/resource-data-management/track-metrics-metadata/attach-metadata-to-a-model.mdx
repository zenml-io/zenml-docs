...
subtitle: >-
  ...
  auditability.
slug: >-
  usage/resource-data-management/track-metrics-metadata/attach-metadata-to-a-model
---
...
Once metadata has been logged in an [artifact](attach-metadata-to-an-artifact.mdx), model, or [step](attach-metadata-to-steps.mdx), we can easily fetch the metadata with the ZenML Client:
