...
subtitle: Using materializers to pass custom data types through steps.
slug: usage/resource-data-management/handle-data-artifacts/handle-custom-data-types
---
...
In addition to the built-in materializers, ZenML also provides several integration-specific materializers that can be activated by installing the respective [integration](../../../stack-components/component-guide.mdx):
...
<Note>
    If you are running pipelines with a Docker-based [orchestrator](/stack-components/orchestrators), you need to specify the corresponding integration as `required_integrations` in the `DockerSettings` of your pipeline in order to have the integration materializer available inside your Docker container. See the [pipeline configuration documentation](../../project-setup/use-configuration-files/runtime-configuration.mdx) for more information.
</Note>
...
Also, as briefly outlined in the [configuration docs](../../project-setup/use-configuration-files/what-can-be-configured.mdx) section, which materializer to use for the output of what step can also be configured within YAML config files.
...
Check out [this page](../../../user-guide/guides/starter-guide/manage-artifacts.mdx) for information on your step output names and how to customize them.
...
<Frame caption="Evidently Artifact Visualization Example">
  <img src="../../../_assets/how-to/stack-52.png"/>
</Frame>
...
Read more about visualizations [here](../visualize-artifacts/creating-custom-visualizations.mdx).
...
You can learn more about skipping materialization [here](unmaterialized-artifacts.mdx).
