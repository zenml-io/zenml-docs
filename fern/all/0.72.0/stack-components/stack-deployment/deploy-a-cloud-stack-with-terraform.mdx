...
subtitle: Deploy a cloud stack using Terraform
slug: stack-components/stack-deployment/deploy-a-cloud-stack-with-terraform
---
...
If you prefer a more automated approach, you can use [the 1-click stack deployment feature](deploy-a-cloud-stack.mdx) to deploy a cloud stack with ZenML with minimal knowledge of Terraform or cloud infrastructure for that matter.
