---
title: Neptune
subtitle: Logging and visualizing experiments with neptune.ai
slug: stack-components/experiment-trackers/neptune
---
...
This method requires you to [configure a ZenML secret](../../usage/project-setup/use-secrets/interact-with-secrets.mdx) to store the Neptune tracking service credentials securely.
