...
subtitle: Executing individual steps in Vertex AI.
slug: stack-components/step-operators/vertex
---
...
* you have access to Vertex AI. If you're using a different cloud provider, take a look at the [SageMaker](sagemaker.mdx) or [AzureML](azureml.mdx) step operators.
...
* A [GCR container registry](../container-registries/gcp.mdx) as part of our stack.
