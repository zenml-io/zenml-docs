...
subtitle: Orchestrating your pipelines to run on Amazon Sagemaker.
slug: stack-components/orchestrators/sagemaker
---
...
The recommended way to authenticate your SageMaker orchestrator is by registering an [AWS Service Connector](../../usage/resource-data-management/auth-management/aws-service-connector.mdx) and connecting it to your SageMaker orchestrator:
...
Sagemaker Studio launch">
  <img src="../../_assets/stack-components/stack-components-3.png"/>
</Frame>
...
<Frame caption="Sagemaker Studio Pipelines">
  <img src="../../_assets/stack-components/stack-components-4.png"/>
</Frame>
...
<Frame caption="SageMaker Studio Logs">
  <img src="../../_assets/stack-components/stack-components-5.png"/>
</Frame>
...
<Frame caption="SageMaker CloudWatch Logs">
  <img src="../../_assets/stack-components/stack-components-6.png"/>
</Frame>
...
Check out [this docs page](../../usage/project-setup/use-configuration-files/runtime-configuration.mdx) for more information on how to specify settings in general.
