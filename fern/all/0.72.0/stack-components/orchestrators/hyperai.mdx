...
subtitle: Orchestrating your pipelines to run on HyperAI.ai instances.
slug: stack-components/orchestrators/hyperai
---
...
[Scheduled pipelines](../../usage/pipelines/build-pipelines/schedule-a-pipeline.mdx) are supported by the HyperAI orchestrator. Currently, the HyperAI orchestrator supports the following inputs to `Schedule`:
