---
title: Prodigy
subtitle: Annotating data using Prodigy.
slug: stack-components/annotators/prodigy
---
...
<Frame caption="Prodigy Annotator">
  <img src="../../_assets/stack-components/stack-components-37.png"/>
</Frame>
...
With Prodigy, there is no need to specially start the annotator ahead of time like with [Label Studio](label-studio.mdx). Instead, just use Prodigy as per the [Prodigy docs](https://prodi.gy) and then you can use the ZenML wrapper / API to get your labeled data etc using our Python methods.
