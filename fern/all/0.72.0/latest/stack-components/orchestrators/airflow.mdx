...
subtitle: Orchestrating your pipelines to run on Airflow.
slug: stack-components/orchestrators/airflow
---
...
You can [schedule pipeline runs](../../usage/pipelines/build-pipelines/schedule-a-pipeline.mdx) on Airflow similarly to other orchestrators. However, note that **Airflow schedules always need to be set in the past**, e.g.,:
