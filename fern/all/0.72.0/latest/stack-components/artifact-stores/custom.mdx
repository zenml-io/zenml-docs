...
subtitle: Learning how to develop a custom artifact store.
slug: stack-components/artifact-stores/custom
---


<Info>
    Before diving into the specifics of this component type, it is beneficial to familiarize yourself with our [general guide to writing custom component flavors in ZenML](../stack-deployment/implement-a-custom-stack-component.mdx). This guide provides an essential understanding of ZenML's component flavor concepts.
</Info>
...
2. Create a class that inherits from [the BaseArtifactStoreConfig class](custom.mdx) and fill in the `SUPPORTED_SCHEMES` based on your file system.
3. Bring both of these classes together by inheriting from [the BaseArtifactStoreFlavor class](custom.mdx).
