---
title: AzureML
subtitle: Executing individual steps in AzureML.
slug: stack-components/step-operators/azureml
---
...
* you have access to AzureML. If you're using a different cloud provider, take a look at the [SageMaker](sagemaker.mdx) or [Vertex](vertex.mdx) step operators.

### How to deploy it

<Info>
    Would you like to skip ahead and deploy a full ZenML cloud stack already, including an AzureML step operator? Check out the [in-browser stack deployment wizard](../stack-deployment/deploy-a-cloud-stack.mdx), the [stack registration wizard](../stack-deployment/register-a-cloud-stack.mdx), or [the ZenML Azure Terraform module](../stack-deployment/deploy-a-cloud-stack-with-terraform.mdx) for a shortcut on how to deploy & register this stack component.
</Info>
...
* An [Azure container registry](../container-registries/azure.mdx) as part of your stack. Take a look [here](/stack-components/container-registries/azure#how-to-deploy-it) for a guide on how to set that up.
* An [Azure artifact store](../artifact-stores/azure.mdx) as part of your stack. This is needed so that both your orchestration environment and AzureML can read and write step artifacts. Take a look [here](/stack-components/container-registries/azure#how-to-deploy-it) for a guide on how to set that up.
