---
title: Overview
subtitle: Managing data in feature stores.
slug: stack-components/feature-stores/feature-stores
---
...
| ---------------------------------------------------------------- | -------- | ------------------------------------------------------------------------ | ----------------------------------------- |
| [FeastFeatureStore](feast.mdx)      | feast    | feast                                                                    | Connect ZenML with already existing Feast |
| [Custom Implementation](custom.mdx) | _custom_ | Extend the feature store abstraction and provide your own implementation |                                           |
