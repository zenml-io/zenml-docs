---
title: Overview
subtitle: Sending automated alerts to chat services.
slug: stack-components/alerters/alerters
---
...
Currently, the [SlackAlerter](slack.mdx) and [DiscordAlerter](discord.mdx) are the available alerter integrations. However, it is straightforward to extend ZenML and [build an alerter for other chat services](custom.mdx).

| Alerter                                                    | Flavor   | Integration                                                        | Notes                            |
| ---------------------------------------------------------- | -------- | ------------------------------------------------------------------ | -------------------------------- |
| [Slack](slack.mdx)                  | slack    | slack                                                              | Interacts with a Slack channel   |
| [Discord](discord.mdx)              | discord  | discord                                                            | Interacts with a Discord channel |
| [Custom Implementation](custom.mdx) | _custom_ | Extend the alerter abstraction and provide your own implementation |                                  |
