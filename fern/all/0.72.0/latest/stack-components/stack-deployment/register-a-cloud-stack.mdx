...
subtitle: Seamlessly register a cloud stack by using existing infrastructure
slug: stack-components/stack-deployment/register-a-cloud-stack
---
...
If you do not have the required infrastructure pieces already deployed on your cloud, you can also use [the 1-click deployment tool to build your cloud stack](deploy-a-cloud-stack.mdx).

Alternatively, if you prefer to have more control over where and how resources are provisioned in your cloud, you can [use one of our Terraform modules](deploy-a-cloud-stack-with-terraform.mdx) to manage your infrastructure as code yourself.
...
<Frame caption="New stack options">
   <img src="../../_assets/how-to/stack-44.png"/>
</Frame>
...
To register the cloud stack, the first thing that the wizard needs is a [service connector](../../usage/resource-data-management/auth-management/service-connectors-guide.mdx). You can either use an existing connector by providing its ID or name `-sc <SERVICE_CONNECTOR_ID_OR_NAME>` (CLI-Only) or the wizard will create one for you.
