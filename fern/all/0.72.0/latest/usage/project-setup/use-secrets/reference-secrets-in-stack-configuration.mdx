...
subtitle: Reference secrets in stack component attributes and settings
slug: usage/project-setup/use-secrets/reference-secrets-in-stack-configuration
---
...
If you are using [centralized secrets management](interact-with-secrets.mdx), you can access secrets directly from within your steps through the ZenML `Client` API. This allows you to use your secrets for querying APIs from within your step without hard-coding your access keys:
...
* [Interact with secrets](interact-with-secrets.mdx): Learn how to create, list, and delete secrets using the ZenML CLI and Python SDK.
