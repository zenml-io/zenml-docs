...
subtitle: >-
  The configuration for specifying pip and apt dependencies only works in the
  remote pipeline case, and is disregarded for local pipelines (i.e. pipelines
  that run locally without having to build a Docker image).
slug: >-
  usage/project-setup/customize-docker-builds/specify-pip-dependencies-and-apt-packages
---
...
def my_pipeline(...):
    ...
```
* Specify a list of [ZenML integrations](../../../stack-components/component-guide.mdx) that you're using in your pipeline:
