...
subtitle: How to control ZenML behavior with environmental variables.
slug: >-
  usage/project-setup/configure-python-environments/configure-the-server-environment
---
...
Usually, ZenML [stores step logs in the artifact store](../../development-monitoring/control-logging/enable-or-disable-logs-storing.mdx), but this can sometimes cause performance bottlenecks, especially if the code utilizes progress bars.
