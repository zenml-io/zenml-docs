...
subtitle: Automatically configure your steps to retry if they fail.
slug: usage/pipelines/build-pipelines/retry-steps
---
...
<CardGroup cols={2}>
<Card title="Failure/Success Hooks" icon="basketball" href="use-failure-success-hooks.mdx" horizontal />
<Card title="Configure Pipelines" icon="gear" href="../../project-setup/use-configuration-files/how-to-use-config.mdx" horizontal />
</CardGroup>
