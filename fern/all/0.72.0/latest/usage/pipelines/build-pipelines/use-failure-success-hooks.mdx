...
subtitle: Running failure and success hooks after step execution.
slug: usage/pipelines/build-pipelines/use-failure-success-hooks
---
...
>
_To set up the local environment used below, follow the recommendations from the_ [_Project templates_](../../project-setup/setting-up-a-project-repository/using-project-templates.mdx)_._
...
Similar as for regular ZenML steps, you can use the [StepContext](../../resource-data-management/track-metrics-metadata/fetch-metadata-within-steps.mdx) to access information about the current pipeline run or step inside your hook function:
...
Inside the helper function `build_message()`, you will find an example on how developers can work with [StepContext](../../resource-data-management/track-metrics-metadata/fetch-metadata-within-steps.mdx) to form a proper notification:
