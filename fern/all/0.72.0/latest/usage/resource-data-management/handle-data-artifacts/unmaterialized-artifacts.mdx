...
subtitle: Skip materialization of artifacts.
slug: usage/resource-data-management/handle-data-artifacts/unmaterialized-artifacts
---
...
You can see another example of using an `UnmaterializedArtifact` when triggering a [pipeline from another](../../pipelines/trigger-pipelines/trigger-a-pipeline-from-another.mdx).
