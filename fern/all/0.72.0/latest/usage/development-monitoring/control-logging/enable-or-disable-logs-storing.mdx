...
subtitle: >-
  ...
  the execution of a step. Users are free to use the default python logging
  module or print statements, and ZenML's logging handler will catch these logs
  and store them.
slug: usage/development-monitoring/control-logging/enable-or-disable-logs-storing
---
...
<Frame caption="Displaying step logs on the dashboard">
  <img src="../../../_assets/how-to/stack-47.png" />
</Frame>

<Note>
    Note that if you are not connected to a cloud artifact store with a service connector configured then you will not be able to view your logs in the dashboard. Read more [here](view-logs-on-the-dasbhoard.mdx).
</Note>
