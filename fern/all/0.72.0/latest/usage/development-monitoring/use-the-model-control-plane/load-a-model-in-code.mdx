...
subtitle: There are a few different ways to load a ZenML Model in code
slug: usage/development-monitoring/use-the-model-control-plane/load-a-model-in-code
---


## Load the active model in a pipeline

You can also use the [active model](../../../user-guide/guides/starter-guide/track-ml-models.mdx) to get the model metadata, or the associated artifacts directly as described in the [starter guide](../../../user-guide/guides/starter-guide/track-ml-models.mdx):
