---
title: Run on AWS
subtitle: A simple guide to create an AWS stack to run your ZenML pipelines
slug: usage/development-monitoring/popular-integrations/aws-guide
---
...
An [artifact store](../../../user-guide/guides/production-guide/remote-storage.mdx) is used for storing and versioning data flowing through your pipelines.
...
More details [here](../../../stack-components/artifact-stores/s3.mdx).

### Orchestrator (SageMaker Pipelines)

An [orchestrator](../../../user-guide/guides/production-guide/cloud-orchestration.mdx) is the compute backend to run your pipelines.
...
More details [here](../../../stack-components/orchestrators/sagemaker.mdx).
...
More details [here](../../../stack-components/container-registries/aws.mdx).
...
<Frame caption="Sequence of events that happen when running a pipeline on a remote stack with a code repository">
  <img src="../../../_assets/how-to/stack-70.png"/>
</Frame>
