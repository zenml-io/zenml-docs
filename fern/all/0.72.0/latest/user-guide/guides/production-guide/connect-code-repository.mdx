...
subtitle: >-
  ...
  MLOps projects.
slug: user-guide/guides/production-guide/connect-code-repository
---
...
While ZenML supports [many different flavors of git repositories](../../../usage/project-setup/setting-up-a-project-repository/connect-your-git-repository.mdx), this guide will focus on [GitHub](https://github.com). To create a repository on GitHub:
...
<Frame caption="Sequence of events that happen when running a pipeline on a remote stack with a code repository
">
  <img src="../../../_assets/user-guide/production-guide/git-1.png" />
</Frame>
...
<Frame >
  <img src="../../../_assets/user-guide/production-guide/git-3.png" />
</Frame>

5. Click on "Generate token" and copy the token to a safe place.

<Frame >
  <img src="../../../_assets/user-guide/production-guide/git-4.png" />
</Frame>
...
You can read more about [the ZenML Git Integration here](../../../usage/project-setup/setting-up-a-project-repository/connect-your-git-repository.mdx).
