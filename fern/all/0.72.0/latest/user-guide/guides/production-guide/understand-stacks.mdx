...
subtitle: Learning how to switch the infrastructure backend of your code.
slug: user-guide/guides/production-guide/understand-stacks
---


Now that we have ZenML deployed, we can take the next steps in making sure that our machine learning workflows are production-ready. As you were running [your first pipelines](../starter-guide/create-an-ml-pipeline.mdx), you might have already noticed the term `stack` in the logs and on the dashboard.
...
There are many more components that you can add to your stacks, like experiment trackers, model deployers, and more. You can see all supported stack component types in a single table view [here](../../../stack-components/component-guide.mdx)
...
Let's use the pipeline in our starter project from the [previous guide](../starter-guide/starter-project.mdx) to see it in action.
