...
* [generating synthetic data with distilabel](finetuning-embeddings/synthetic-data-generation.mdx)
* [finetuning embeddings with Sentence Transformers](finetuning-embeddings/finetuning-embeddings-with-sentence-transformers.mdx)
* [evaluating finetuned embeddings and using ZenML's model control plane to get a systematic overview](finetuning-embeddings/evaluating-finetuned-embeddings.mdx)
