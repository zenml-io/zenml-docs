...
subtitle: Use your RAG components to generate responses to prompts.
slug: user-guide/guides/llmops-guide/rag-with-zenml/basic-rag-inference-pipeline
---
...
<Frame caption="The Supabase editor interface">
  <img src="../../../../_assets/user-guide/data-int-7.png"/>
</Frame>
