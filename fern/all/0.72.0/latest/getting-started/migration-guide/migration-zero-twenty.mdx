...
subtitle: How to migrate from ZenML versions up to 0.13.2 to 0.20.0.
slug: getting-started/migration-guide/migration-zero-twenty
---
...
Read more about this paradigm in the [new docs section about settings](../../usage/project-setup/use-configuration-files/what-can-be-configured.mdx).
