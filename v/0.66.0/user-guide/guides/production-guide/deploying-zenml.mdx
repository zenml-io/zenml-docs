...
While there are many options on how to [deploy ZenML](/v/0.66.0/getting-started/deploying-zenml), the two simplest ones are:
...
To learn more about different options for [deploying ZenML, visit the deployment documentation](/v/0.66.0/getting-started/deploying-zenml).
...
<Info>
  Having trouble connecting with a browser? There are other ways to connect. Read [here](/v/0.66.0/usage/resource-data-management/connecting-to-zenml) for more details.
</Info>
