...
You can see another example of using an `UnmaterializedArtifact` when triggering a [pipeline from another](v/0.66.0/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-another).
