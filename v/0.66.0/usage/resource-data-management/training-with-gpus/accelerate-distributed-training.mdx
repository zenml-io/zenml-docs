...
For complete details, refer to the [containerization page](v/0.66.0/usage/project-setup/customize-docker-builds). Here's an example using a CUDA-enabled PyTorch image:
