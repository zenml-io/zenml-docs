...
<Info>
  Learn how to get a bearer token for the curl commands [here](/v/0.66.0/api/api-reference#using-a-bearer-token-to-access-the-api-programmatically).
</Info>
...
<CardGroup>
 <Card title="Run Pipeline from Another" icon="diagram-project" href="/v/0.66.0/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-another" horizontal/> <Card title="Run Pipeline from Python Client" icon="python" href="/v/0.66.0/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-client" horizontal/> </CardGroup>
