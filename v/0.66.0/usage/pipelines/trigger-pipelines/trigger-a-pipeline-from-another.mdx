...
Read more about Unmaterialized Artifacts [here](/v/0.66.0/usage/resource-data-management/handle-data-artifacts/unmaterialized-artifacts).

<CardGroup>
<Card title="Run Pipeline from Python Client" icon="python" href="/v/0.66.0/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-client" horizontal/> <Card title="Run Pipeline from REST API" icon="code" href="/v/0.66.0/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-rest-api" horizontal/> </CardGroup>
