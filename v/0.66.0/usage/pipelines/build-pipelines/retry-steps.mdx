...
<CardGroup cols={2}>
<Card title="Failure/Success Hooks" icon="basketball" href="/v/0.66.0/usage/pipelines/build-pipelines/use-failure-success-hooks" horizontal />
<Card title="Configure Pipelines" icon="gear" href="/v/0.66.0/usage/project-setup/use-configuration-files/how-to-use-config" horizontal />
</CardGroup>
