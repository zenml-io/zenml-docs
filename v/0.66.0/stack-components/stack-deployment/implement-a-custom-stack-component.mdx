...
As each component defines a different interface, make sure to check out the base class definition of the component type that you want to implement and also check out the [documentation on how to extend specific stack components](v/0.66.0/stack-components/stack-deployment/implement-a-custom-stack-component#extending-specific-stack-components).

<Info>
    If you would like to automatically track some metadata about your custom stack component with each pipeline run, you can do so by defining some additional methods in your stack component implementation class as shown in the [Tracking Custom Stack Component Metadata](v/0.66.0/usage/resource-data-management/track-metrics-metadata/fetch-metadata-within-steps) section.
</Info>
...
You can read more about the differences [here](v/0.66.0/usage/project-setup/use-configuration-files/runtime-configuration).
...
<Info>
    You can pass sensitive configuration values as [secrets](v/0.66.0/usage/project-setup/use-secrets/interact-with-secrets) by defining them as type `SecretField` in the configuration class.
</Info>
...
| ------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Orchestrator](v/0.66.0/stack-components/orchestrators/custom)              | Orchestrating the runs of your pipeline                           |
| [Artifact Store](v/0.66.0/stack-components/artifact-stores/custom)          | Storage for the artifacts created by your pipelines               |
| [Container Registry](v/0.66.0/stack-components/container-registries/custom) | Store for your containers                                         |
| [Step Operator](v/0.66.0/stack-components/step-operators/custom)            | Execution of individual steps in specialized runtime environments |
| [Model Deployer](v/0.66.0/stack-components/model-deployers/custom)          | Services/platforms responsible for online model serving           |
| [Feature Store](v/0.66.0/stack-components/feature-stores/custom)            | Management of your data/features                                  |
| [Experiment Tracker](v/0.66.0/stack-components/experiment-trackers/custom)  | Tracking your ML experiments                                      |
| [Alerter](v/0.66.0/stack-components/alerters/custom)                        | Sending alerts through specified channels                         |
| [Annotator](v/0.66.0/stack-components/annotators/custom)                    | Annotating and labeling data                                      |
| [Data Validator](v/0.66.0/stack-components/data-validators/custom)          | Validating and monitoring your data                               |
