...
<Info>
    Instead of hardcoding an experiment tracker name, you can also use the [Client](/v/0.66.0sdk/python-client) to dynamically use the experiment tracker of your active stack, as shown in the example above.
</Info>
