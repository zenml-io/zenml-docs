...
The local orchestrator is an [orchestrator](v/0.66.0/stack-components/orchestrators) flavor that comes built-in with ZenML and runs your pipelines locally.
