...
<Info>
Instead of hardcoding a step operator name, you can also use the [Client](/v/0.66.0sdk/python-client) to dynamically use the step operator of your active stack:
