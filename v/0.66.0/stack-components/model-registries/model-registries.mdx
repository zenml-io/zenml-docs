...
| ------------------------------------------------------------------ | -------- | ----------- | ------------------------------------------ |
| [MLflow](/v/0.66.0/stack-components/model-registries/mlflow)                | mlflow   | mlflow      | Add MLflow as Model Registry to your stack |
| [Custom Implementation](/v/0.66.0/stack-components/model-registries/custom) | _custom_ | _custom_    |                                            |
