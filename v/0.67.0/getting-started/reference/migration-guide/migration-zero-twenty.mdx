...
Read more about this paradigm in the [new docs section about settings](/v/0.67.0/versions/0.66.0/how-to/use-configuration-files/what-can-be-configured).
