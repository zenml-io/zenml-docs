...
<CardGroup>
 <Card title="Run Pipeline from Another" icon="diagram-project" href="/v/0.67.0/versions/0.66.0/how-to/trigger-pipelines/trigger-a-pipeline-from-another" horizontal/> <Card title="Run Pipeline from REST API" icon="code" href="/v/0.67.0/versions/0.66.0/how-to/trigger-pipelines/trigger-a-pipeline-from-rest-api" horizontal/></CardGroup>
