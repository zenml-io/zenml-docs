...
<Info>
    When defining a step that should be run remotely in a notebook, make sure you're aware of all the [limitations](/v/0.67.0/versions/0.66.0/how-to/run-remote-steps-and-pipelines-from-notebooks/limitations-of-defining-steps-in-notebook-cells) that apply.
</Info>
