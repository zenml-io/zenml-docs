...
For complete details, refer to the [containerization page](/v/0.67.0/versions/0.66.0/how-to/customize-docker-builds). Here's an example using a CUDA-enabled PyTorch image:
