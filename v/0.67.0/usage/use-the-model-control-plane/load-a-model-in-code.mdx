...
You can also use the [active model](/v/0.67.0/versions/0.66.0/user-guide/starter-guide/track-ml-models) to get the model metadata, or the associated artifacts directly as described in the [starter guide](/v/0.67.0/versions/0.66.0/user-guide/starter-guide/track-ml-models):
