...
description: "One of the more common use-cases for a Model is to pass artifacts between pipelines (a pattern we have seen [before](/v/0.67.0/versions/0.66.0/how-to/use-the-model-control-plane/connecting-artifacts-via-a-model))."
icon: spinner
---
