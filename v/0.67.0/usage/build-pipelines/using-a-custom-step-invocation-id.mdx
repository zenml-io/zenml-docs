...
description: "When calling a ZenML step as part of your pipeline, it gets assigned a unique **invocation ID** that you can use to reference this step invocation when [defining the execution order](/v/0.67.0/versions/0.66.0/how-to/build-pipelines/control-execution-order-of-steps) of your pipeline steps or use it to [fetch information](/v/0.67.0/versions/0.66.0/how-to/build-pipelines/fetching-pipelines) about the invocation after the pipeline has finished running."
icon: fingerprint
---
