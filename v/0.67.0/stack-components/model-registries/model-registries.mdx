...
| ------------------------------------------------------------------ | -------- | ----------- | ------------------------------------------ |
| [MLflow](/latest/stack-components/model-registries/mlflow)                | mlflow   | mlflow      | Add MLflow as Model Registry to your stack |
| [Custom Implementation](/latest/stack-components/model-registries/custom) | _custom_ | _custom_    |                                            |
