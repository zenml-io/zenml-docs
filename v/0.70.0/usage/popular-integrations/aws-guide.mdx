...
* ZenML [installed](/v/0.70.0/versions/0.66.0/getting-started/installation)
...
An [artifact store](/v/0.70.0/versions/0.66.0/user-guide/production-guide/remote-storage) is used for storing and versioning data flowing through your pipelines.
...
More details [here](/v/0.70.0/versions/0.66.0/stack-components/artifact-stores/s3).

### Orchestrator (SageMaker Pipelines)

An [orchestrator](/v/0.70.0/versions/0.66.0/user-guide/production-guide/cloud-orchestration) is the compute backend to run your pipelines.
...
More details [here](/v/0.70.0/versions/0.66.0/stack-components/orchestrators/sagemaker).

### Container Registry (ECR)

A [container registry](/v/0.70.0/versions/0.66.0/stack-components/container-registries) is used to store Docker images for your pipelines.
...
More details [here](/v/0.70.0/versions/0.66.0/stack-components/container-registries/aws).
...
* Explore ZenML's [integrations](/v/0.70.0/versions/0.66.0/stack-components/component-guide) with other popular tools and frameworks in the machine learning ecosystem.
