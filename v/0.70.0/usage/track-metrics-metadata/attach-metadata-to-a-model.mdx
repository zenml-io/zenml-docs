...
Once metadata has been logged in an [artifact](/v/0.70.0/versions/0.66.0/how-to/track-metrics-metadata/attach-metadata-to-an-artifact), model, or [step](/v/0.70.0/versions/0.66.0/how-to/track-metrics-metadata/attach-metadata-to-steps), we can easily fetch the metadata with the ZenML Client:
