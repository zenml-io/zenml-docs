...
* Check out the [common errors](/v/0.70.0/versions/0.66.0/how-to/debug-and-solve-issues#most-common-errors) section below.
* Understand the problem by studying the [additional logs](/v/0.70.0/versions/0.66.0/how-to/debug-and-solve-issues#41-additional-logs) and [client/server logs](/v/0.70.0/versions/0.66.0/how-to/debug-and-solve-issues#client-and-server-logs).
...
This also applies to all other [stack components](/v/0.70.0/versions/0.66.0/stack-components/component-guide).
