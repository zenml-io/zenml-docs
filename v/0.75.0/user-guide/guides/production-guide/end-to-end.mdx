...
* The value of [deploying ZenML](/latest/versions/0.66.0/user-guide/production-guide/deploying-zenml)
* Abstracting infrastructure configuration into [stacks](/latest/versions/0.66.0/user-guide/production-guide/understand-stacks)
* [Connecting remote storage](/latest/versions/0.66.0/user-guide/production-guide/remote-storage)
* [Orchestrating on the cloud](/latest/versions/0.66.0/user-guide/production-guide/cloud-orchestration)
* [Configuring the pipeline to scale compute](/latest/versions/0.66.0/user-guide/production-guide/configure-pipeline)
* [Connecting a git repository](/latest/versions/0.66.0/user-guide/production-guide/connect-code-repository)
...
We will then use [ZenML templates](/latest/versions/0.66.0/how-to/setting-up-a-project-repository/using-project-templates) to help us get the code we need for the project:
