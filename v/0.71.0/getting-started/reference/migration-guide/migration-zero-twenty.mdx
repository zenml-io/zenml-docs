...
Read more about this paradigm in the [new docs section about settings](/latest/versions/0.66.0/how-to/use-configuration-files/what-can-be-configured).
