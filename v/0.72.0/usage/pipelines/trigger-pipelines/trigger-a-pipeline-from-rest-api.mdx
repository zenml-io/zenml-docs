...
<Info>
  Learn how to get a bearer token for the curl commands [here](/latest/api/api-reference#using-a-bearer-token-to-access-the-api-programmatically).
</Info>
...
<CardGroup>
 <Card title="Run Pipeline from Another" icon="diagram-project" href="/latest/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-another" horizontal/> <Card title="Run Pipeline from Python Client" icon="python" href="/latest/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-client" horizontal/> </CardGroup>
