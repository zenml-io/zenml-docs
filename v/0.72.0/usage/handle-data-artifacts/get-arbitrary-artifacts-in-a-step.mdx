...
As described in [the metadata guide](/latest/versions/0.66.0/how-to/track-metrics-metadata/logging-metadata), the metadata can be fetched with the client, and this is how you would use it to fetch it within a step. This allows you to fetch artifacts from other upstream steps or even completely different pipelines.
...
* [Managing artifacts](/latest/versions/0.66.0/user-guide/starter-guide/manage-artifacts) \- learn about the `ExternalArtifact` type and how to pass artifacts between steps.
