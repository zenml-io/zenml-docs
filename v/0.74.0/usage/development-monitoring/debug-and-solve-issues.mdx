...
* Check out the [common errors](/latest/usage/development-monitoring/debug-and-solve-issues#most-common-errors) section below.
* Understand the problem by studying the [additional logs](/latest/usage/development-monitoring/debug-and-solve-issues#41-additional-logs) and [client/server logs](/latest/usage/development-monitoring/debug-and-solve-issues#client-and-server-logs).
...
This also applies to all other [stack components](/latest/stack-components/component-guide).
