...
The local orchestrator is an [orchestrator](/develop/stack-components/orchestrators) flavor that comes built-in with ZenML and runs your pipelines locally.
