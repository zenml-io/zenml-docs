...
If you are looking for a more easy way to deploy your models locally, you can use the [MLflow Model Deployer](/develop/stack-components/model-deployers/mlflow) flavor.
...
* [the AWS Service Connector](/develop/usage/resource-data-management/auth-management/aws-service-connector), if you are using an AWS EKS cluster.
* [the GCP Service Connector](/develop/usage/resource-data-management/auth-management/gcp-service-connector), if you are using a GKE cluster.
* [the Azure Service Connector](/develop/usage/resource-data-management/auth-management/azure-service-connector), if you are using an AKS cluster.
* [the generic Kubernetes Service Connector](/develop/usage/resource-data-management/auth-management/kubernetes-service-connector) for any other Kubernetes cluster.
