...
While ZenML supports [many different flavors of git repositories](/develop/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository), this guide will focus on [GitHub](https://github.com). To create a repository on GitHub:
...
We can now push our local code (from the [previous chapters](/develop/user-guide/guides/production-guide/understand-stacks#run-a-pipeline-on-the-new-local-stack)) to GitHub with these commands:
...
You can read more about [the ZenML Git Integration here](/develop/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository).
