...
While there are many options on how to [deploy ZenML](/develop/getting-started/deploying-zenml), the two simplest ones are:
...
To learn more about different options for [deploying ZenML, visit the deployment documentation](/develop/getting-started/deploying-zenml).
...
<Info>
  Having trouble connecting with a browser? There are other ways to connect. Read [here](/develop/usage/resource-data-management/connecting-to-zenml) for more details.
</Info>
