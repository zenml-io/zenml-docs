...
As with the [retrieval evaluation](/develop/user-guide/guides/llmops-guide/evaluation/retrieval), we can start with a simple approach and then move on to more sophisticated methods.
