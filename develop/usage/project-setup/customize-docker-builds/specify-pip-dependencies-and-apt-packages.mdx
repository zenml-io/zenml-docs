...
def my_pipeline(...):
    ...
```
* Specify a list of [ZenML integrations](/develop/stack-components/component-guide) that you're using in your pipeline:
