...
* ZenML [installed](/develop/getting-started/installation).
...
Once you have created the service principal and the client secret, you can go ahead and create [a ZenML Azure Service Connector](/develop/usage/resource-data-management/auth-management/azure-service-connector).
...
For more information regarding Azure Blob Storage artifact stores, feel free to [check the docs](/develop/stack-components/artifact-stores/azure).
...
For more information regarding AzureML orchestrator, feel free to [check the docs](/develop/stack-components/orchestrators/azureml).
...
For more information regarding Azure container registries, feel free to [check the docs](/develop/stack-components/container-registries/azure).
...
* Explore ZenML's [integrations](/develop/stack-components/component-guide) with other popular tools and frameworks in the machine learning ecosystem.
