...
<Info>
    When defining a step that should be run remotely in a notebook, make sure you're aware of all the [limitations](/develop/usage/development-monitoring/run-remote-steps-and-pipelines-from-notebooks/limitations-of-defining-steps-in-notebook-cells) that apply.
</Info>
