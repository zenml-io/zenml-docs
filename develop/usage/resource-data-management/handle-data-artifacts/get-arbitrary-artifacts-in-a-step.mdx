...
* [Managing artifacts](/develop/user-guide/guides/starter-guide/manage-artifacts) \- learn about the `ExternalArtifact` type and how to pass artifacts between steps.
