...
You can see another example of using an `UnmaterializedArtifact` when triggering a [pipeline from another](/develop/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-another).
